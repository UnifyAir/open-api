...
impl super::ServiceProperties for NssfService {
    fn get_path(&self) -> String {
        match self {
            NssfService::NSSAIAvailability(inner) => format!("/nssaiavailability/{}", inner.get_path()),
...
impl super::ServiceProperties for NssfNSSAIAvailabilityOperation {
    fn get_path(&self) -> String {
        match self {
            NssfNSSAIAvailabilityOperation::Nssaiavailabilityput => "/nssai-availability/{}".to_string(),
            NssfNSSAIAvailabilityOperation::Nssaiavailabilitypatch => "/nssai-availability/{}".to_string(),
            NssfNSSAIAvailabilityOperation::Nssaiavailabilitydelete => "/nssai-availability/{}".to_string(),
            NssfNSSAIAvailabilityOperation::Nssaiavailabilitypost => "/nssai-availability/subscriptions".to_string(),
            NssfNSSAIAvailabilityOperation::Nssaiavailabilityunsubscribe => "/nssai-availability/subscriptions/{}".to_string(),
            NssfNSSAIAvailabilityOperation::Nssaiavailabilitysubmodifypatch => "/nssai-availability/subscriptions/{}".to_string(),
            NssfNSSAIAvailabilityOperation::Nssaiavailabilityoptions => "/nssai-availability".to_string(),
        }
    }
    ...
    fn get_http_method(&self) -> reqwest::Method {
        match self {
            ...
            NssfNSSAIAvailabilityOperation::Nssaiavailabilitysubmodifypatch => reqwest::Method::PATCH,
