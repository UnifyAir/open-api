...
impl super::ServiceProperties for ChfService {
    fn get_path(&self) -> String {
        match self {
            ChfService::SpendingLimitControl(inner) => format!("/spendinglimitcontrol/{}", inner.get_path()),
            ChfService::ConvergedCharging(inner) => format!("/convergedcharging/{}", inner.get_path()),
            ChfService::OfflineOnlyCharging(inner) => format!("/offlineonlycharging/{}", inner.get_path()),
        }
    }
...
impl super::ServiceProperties for ChfConvergedChargingOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            ChfConvergedChargingOperation::Postchargingdataupdate => "/chargingdata/{}/update".to_string(),
            ChfConvergedChargingOperation::Postchargingdatarelease => "/chargingdata/{}/release".to_string(),
        }
    }
...
impl super::ServiceProperties for ChfOfflineOnlyChargingOperation {
    fn get_path(&self) -> String {
        match self {
            ChfOfflineOnlyChargingOperation::Postofflinechargingdata => "/offlinechargingdata".to_string(),
            ChfOfflineOnlyChargingOperation::Postofflinechargingdataupdate => "/offlinechargingdata/{}/update".to_string(),
            ChfOfflineOnlyChargingOperation::Postofflinechargingdatarelease => "/offlinechargingdata/{}/release".to_string(),
        }
    }
    ...
    fn get_http_method(&self) -> reqwest::Method {
        match self {
            ...
            ChfOfflineOnlyChargingOperation::Postofflinechargingdatarelease => reqwest::Method::POST,
        }
    }
}
