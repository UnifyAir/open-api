...
impl super::ServiceProperties for MbsmfMBSSessionOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            MbsmfMBSSessionOperation::Statussubscribemod => "/mbs-sessions/subscriptions/{}".to_string(),
            MbsmfMBSSessionOperation::Statusunsubscribe => "/mbs-sessions/subscriptions/{}".to_string(),
            MbsmfMBSSessionOperation::Contextstatussubscribe => "/mbs-sessions/contexts/subscriptions".to_string(),
            MbsmfMBSSessionOperation::Contextstatussubscribemod => "/mbs-sessions/contexts/subscriptions/{}".to_string(),
            MbsmfMBSSessionOperation::Contextstatusunsubscribe => "/mbs-sessions/contexts/subscriptions/{}".to_string(),
        }
    }
