...
impl super::ServiceProperties for UdmUEAUOperation {
    fn get_path(&self) -> String {
        match self {
            UdmUEAUOperation::Generateauthdata => "/{}/security-information/generate-auth-data".to_string(),
            UdmUEAUOperation::Getrgauthdata => "/{}/security-information-rg".to_string(),
            UdmUEAUOperation::Confirmauth => "/{}/auth-events".to_string(),
            UdmUEAUOperation::Generateav => "/{}/hss-security-information/{}/generate-av".to_string(),
            UdmUEAUOperation::Deleteauth => "/{}/auth-events/{}".to_string(),
            UdmUEAUOperation::Generategbaav => "/{}/gba-security-information/generate-av".to_string(),
            UdmUEAUOperation::Generateproseav => "/{}/prose-security-information/generate-av".to_string(),
        }
    }
...
impl super::ServiceProperties for UdmUECMOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            UdmUECMOperation::Sendroutinginfosm => "/{}/registrations/send-routing-info-sm".to_string(),
            UdmUECMOperation::Op3gppregistration => "/{}/registrations/amf-3gpp-access".to_string(),
            UdmUECMOperation::Update3gppregistration => "/{}/registrations/amf-3gpp-access".to_string(),
            ...
            UdmUECMOperation::Peiupdate => "/{}/registrations/amf-3gpp-access/pei-update".to_string(),
            UdmUECMOperation::Updateroaminginformation => "/{}/registrations/amf-3gpp-access/roaming-info-update".to_string(),
            UdmUECMOperation::Non3gppregistration => "/{}/registrations/amf-non-3gpp-access".to_string(),
            UdmUECMOperation::Updatenon3gppregistration => "/{}/registrations/amf-non-3gpp-access".to_string(),
            UdmUECMOperation::Getnon3gppregistration => "/{}/registrations/amf-non-3gpp-access".to_string(),
            UdmUECMOperation::Getsmfregistration => "/{}/registrations/smf-registrations".to_string(),
            UdmUECMOperation::Registration => "/{}/registrations/smf-registrations/{}".to_string(),
            UdmUECMOperation::Smfderegistration => "/{}/registrations/smf-registrations/{}".to_string(),
            UdmUECMOperation::Retrievesmfregistration => "/{}/registrations/smf-registrations/{}".to_string(),
            UdmUECMOperation::Updatesmfregistration => "/{}/registrations/smf-registrations/{}".to_string(),
            UdmUECMOperation::Op3gppsmsfregistration => "/{}/registrations/smsf-3gpp-access".to_string(),
            UdmUECMOperation::Op3gppsmsfderegistration => "/{}/registrations/smsf-3gpp-access".to_string(),
            UdmUECMOperation::Get3gppsmsfregistration => "/{}/registrations/smsf-3gpp-access".to_string(),
            UdmUECMOperation::Non3gppsmsfregistration => "/{}/registrations/smsf-non-3gpp-access".to_string(),
            UdmUECMOperation::Non3gppsmsfderegistration => "/{}/registrations/smsf-non-3gpp-access".to_string(),
            UdmUECMOperation::Getnon3gppsmsfregistration => "/{}/registrations/smsf-non-3gpp-access".to_string(),
            ...
            UdmUECMOperation::Getnwdafregistration => "/{}/registrations/nwdaf-registrations".to_string(),
            UdmUECMOperation::Nwdafregistration => "/{}/registrations/nwdaf-registrations/{}".to_string(),
            UdmUECMOperation::Nwdafderegistration => "/{}/registrations/nwdaf-registrations/{}".to_string(),
            UdmUECMOperation::Updatenwdafregistration => "/{}/registrations/nwdaf-registrations/{}".to_string(),
        }
    }
