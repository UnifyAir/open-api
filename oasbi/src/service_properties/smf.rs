...
impl super::ServiceProperties for SmfPDUSessionOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            SmfPDUSessionOperation::Transfermodata => "/pdu-sessions/{}/transfer-mo-data".to_string(),
        }
    }
...
impl super::ServiceProperties for SmfEventExposureOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            SmfEventExposureOperation::Replaceindividualsubcription => "/subscriptions/{}".to_string(),
            SmfEventExposureOperation::Deleteindividualsubcription => "/subscriptions/{}".to_string(),
        }
    }
