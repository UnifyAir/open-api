...
impl super::ServiceProperties for AmfService {
    fn get_path(&self) -> String {
        match self {
            ...
            AmfService::MBSCommunication(inner) => format!("/mbscommunication/{}", inner.get_path()),
...
impl super::ServiceProperties for AmfCommunicationOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            AmfCommunicationOperation::Registrationstatusupdate => "/ue-contexts/{}/transfer-update".to_string(),
            AmfCommunicationOperation::Relocateuecontext => "/ue-contexts/{}/relocate".to_string(),
            AmfCommunicationOperation::Cancelrelocateuecontext => "/ue-contexts/{}/cancel-relocate".to_string(),
            AmfCommunicationOperation::N1n2messagetransfer => "/ue-contexts/{}/n1-n2-messages".to_string(),
            AmfCommunicationOperation::N1n2messagesubscribe => "/ue-contexts/{}/n1-n2-messages/subscriptions".to_string(),
            AmfCommunicationOperation::N1n2messageunsubscribe => "/ue-contexts/{}/n1-n2-messages/subscriptions/{}".to_string(),
            AmfCommunicationOperation::Nonuen2messagetransfer => "/non-ue-n2-messages/transfer".to_string(),
            AmfCommunicationOperation::Nonuen2infosubscribe => "/non-ue-n2-messages/subscriptions".to_string(),
            AmfCommunicationOperation::Nonuen2infounsubscribe => "/non-ue-n2-messages/subscriptions/{}".to_string(),
            ...
            AmfCommunicationOperation::Amfstatuschangesubscribemodfy => "/subscriptions/{}".to_string(),
        }
    }
...
impl super::ServiceProperties for AmfMTOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            AmfMTOperation::Enablegroupreachability => "/ue-contexts/enable-group-reachability".to_string(),
        }
    }
