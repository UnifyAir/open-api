...
impl super::ServiceProperties for PcfService {
    fn get_path(&self) -> String {
        match self {
            ...
            PcfService::PolicyAuthorization(inner) => format!("/policyauthorization/{}", inner.get_path()),
            ...
            PcfService::AMPolicyAuthorization(inner) => format!("/ampolicyauthorization/{}", inner.get_path()),
            PcfService::MBSPolicyAuthorization(inner) => format!("/mbspolicyauthorization/{}", inner.get_path()),
            PcfService::MBSPolicyControl(inner) => format!("/mbspolicycontrol/{}", inner.get_path()),
            PcfService::BDTPolicyControl(inner) => format!("/bdtpolicycontrol/{}", inner.get_path()),
        }
    }
...
impl super::ServiceProperties for PcfPolicyAuthorizationOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            PcfPolicyAuthorizationOperation::Pcscfrestoration => "/app-sessions/pcscf-restoration".to_string(),
            ...
            PcfPolicyAuthorizationOperation::Deleteappsession => "/app-sessions/{}/delete".to_string(),
            PcfPolicyAuthorizationOperation::Updateeventssubsc => "/app-sessions/{}/events-subscription".to_string(),
            PcfPolicyAuthorizationOperation::Deleteeventssubsc => "/app-sessions/{}/events-subscription".to_string(),
        }
    }
...
impl super::ServiceProperties for PcfAMPolicyAuthorizationOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            PcfAMPolicyAuthorizationOperation::Deleteappamcontext => "/app-am-contexts/{}".to_string(),
            PcfAMPolicyAuthorizationOperation::Updateameventssubsc => "/app-am-contexts/{}/events-subscription".to_string(),
            PcfAMPolicyAuthorizationOperation::Deleteameventssubsc => "/app-am-contexts/{}/events-subscription".to_string(),
        }
    }
...
impl super::ServiceProperties for PcfMBSPolicyAuthorizationOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            PcfMBSPolicyAuthorizationOperation::Modifymbsappsessionctxt => "/contexts/{}".to_string(),
            PcfMBSPolicyAuthorizationOperation::Deletembsappsessionctxt => "/contexts/{}".to_string(),
        }
    }
...
impl super::ServiceProperties for PcfMBSPolicyControlOperation {
    fn get_path(&self) -> String {
        match self {
            ...
            PcfMBSPolicyControlOperation::Updateindmbspolicy => "/mbs-policies/{}/update".to_string(),
        }
    }
