...
- API version: 1.2.6
- Build date: 2024-11-10T15:20:53.912718+05:30[Asia/Kolkata]
- Generator version: 7.7.0

This autogenerated project defines an API crate `openapi-udm` which contains:
...
#[async_trait]
impl openapi-udm::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = openapi-udm::server::new(Arc::new(ServerImpl));
