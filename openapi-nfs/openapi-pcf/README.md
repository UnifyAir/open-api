...
- API version: 1.2.6
- Build date: 2024-11-10T19:26:00.652956+05:30[Asia/Kolkata]
- Generator version: 7.7.0

This autogenerated project defines an API crate `openapi-pcf` which contains:
...
#[async_trait]
impl openapi-pcf::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = openapi-pcf::server::new(Arc::new(ServerImpl));
