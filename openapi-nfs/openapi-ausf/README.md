...
- API version: 1.2.6
- Build date: 2024-12-12T19:06:45.820274+05:30[Asia/Kolkata]
- Generator version: 7.7.0

This autogenerated project defines an API crate `openapi-ausf` which contains:
...
#[async_trait]
impl openapi-ausf::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = openapi-ausf::server::new(Arc::new(ServerImpl));
