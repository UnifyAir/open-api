...
pub enum PostSmContextsResponse {
    ...
    Status400_UnsuccessfulCreationOfAnSMContext
    (models::SmContextCreateError)
    ,
    /// unsuccessful creation of an SM context - forbidden
    Status403_UnsuccessfulCreationOfAnSMContext
    (models::SmContextCreateError)
    ,
    /// unsuccessful creation of an SM context - not found
    Status404_UnsuccessfulCreationOfAnSMContext
    (models::SmContextCreateError)
    ,
    /// Length Required
    ...
    Status500_UnsuccessfulCreationOfAnSMContext
    (models::SmContextCreateError)
    ,
    /// unsuccessful creation of an SM context - service unavailable
    Status503_UnsuccessfulCreationOfAnSMContext
    (models::SmContextCreateError)
    ,
    /// unsuccessful creation of an SM context - gateway timeout
    Status504_UnsuccessfulCreationOfAnSMContext
    (models::SmContextCreateError)
    ,
    /// Generic Error
