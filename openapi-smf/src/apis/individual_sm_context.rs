...
pub enum RetrieveSmContextResponse {
    ...
    Status200_SuccessfulRetrievalOfAnSMContext
    (models::SmContextRetrievedData)
    ,
    /// Temporary Redirect
    Status307_TemporaryRedirect
    {
...
pub enum UpdateSmContextResponse {
    ...
    Status200_SuccessfulUpdateOfAnSMContextWithContentInTheResponse
    (models::SmContextUpdatedData)
    ,
    ...
    Status400_UnsuccessfulUpdateOfAnSMContext
    (models::SmContextUpdateError)
    ,
    /// unsuccessful update of an SM context - forbidden
    Status403_UnsuccessfulUpdateOfAnSMContext
    (models::SmContextUpdateError)
    ,
    /// unsuccessful update of an SM context - not found
    Status404_UnsuccessfulUpdateOfAnSMContext
    (models::SmContextUpdateError)
    ,
    /// Length Required
    Status411_LengthRequired
    ...
    Status500_UnsuccessfulUpdateOfAnSMContext
    (models::SmContextUpdateError)
    ,
    /// unsuccessful update of an SM context - Service Unavailable
    Status503_UnsuccessfulUpdateOfAnSMContext
    (models::SmContextUpdateError)
    ,
    /// unsuccessful update of an SM context - gateway timeout
    Status504_UnsuccessfulUpdateOfAnSMContext
    (models::SmContextUpdateError)
    ,
    /// Generic Error
    Status0_GenericError,
