...
pub enum ReleasePduSessionResponse {
    ...
    Status200_SuccessfulReleaseOfAPDUSessionWithContentInTheResponse
    (models::ReleasedData)
    ,
...
pub enum RetrievePduSessionResponse {
    ...
    Status200_SuccessfulInformationRetrieval
    (models::RetrievedData)
    ,
    /// Temporary Redirect
    Status307_TemporaryRedirect
    {
...
pub enum UpdatePduSessionResponse {
    ...
    Status200_SuccessfulUpdateOfAPDUSessionWithContentInTheResponse
    (models::HsmfUpdatedData)
    ,
    ...
    Status400_UnsuccessfulUpdateOfAPDUSession
    (models::HsmfUpdateError)
    ,
    /// unsuccessful update of a PDU session
    Status403_UnsuccessfulUpdateOfAPDUSession
    (models::HsmfUpdateError)
    ,
    /// unsuccessful update of a PDU session
    Status404_UnsuccessfulUpdateOfAPDUSession
    (models::HsmfUpdateError)
    ,
    /// Length Required
    Status411_LengthRequired
    ...
    ,
    /// unsuccessful update of a PDU session
    Status500_UnsuccessfulUpdateOfAPDUSession
    (models::HsmfUpdateError)
    ,
    /// unsuccessful update of a PDU session
    Status503_UnsuccessfulUpdateOfAPDUSession
    (models::HsmfUpdateError)
    ,
    /// Generic Error
    Status0_GenericError,
