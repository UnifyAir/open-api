...
pub enum PostPduSessionsResponse {
    ...
    Status400_UnsuccessfulCreationOfAPDUSession
    (models::PduSessionCreateError)
    ,
    /// unsuccessful creation of a PDU session
    Status403_UnsuccessfulCreationOfAPDUSession
    (models::PduSessionCreateError)
    ,
    /// unsuccessful creation of a PDU session
    Status404_UnsuccessfulCreationOfAPDUSession
    (models::PduSessionCreateError)
    ,
    /// Length Required
    ...
    ,
    /// unsuccessful creation of a PDU session
    Status500_UnsuccessfulCreationOfAPDUSession
    (models::PduSessionCreateError)
    ,
    /// unsuccessful creation of a PDU session
    Status503_UnsuccessfulCreationOfAPDUSession
    (models::PduSessionCreateError)
    ,
    /// Generic Error
