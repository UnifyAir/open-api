...
where
    ...
    A: apis::individual_pdu_session_hsmfor_smf::IndividualPduSessionHsmforSmf + apis::individual_pdu_session_nsmf_nidd::IndividualPduSessionNsmfNidd + apis::individual_sm_context::IndividualSmContext + apis::individual_subscription_document::IndividualSubscriptionDocument + apis::pdu_sessions_collection::PduSessionsCollection + apis::sm_contexts_collection::SmContextsCollection + apis::subscriptions_collection::SubscriptionsCollection + 'static,

{
    // build our application with a route
    Router::new()
        .route("/nsmf-event-exposure/v1/subscriptions",
               post(create_individual_subcription::<I, A>),
        )
        .route("/nsmf-event-exposure/v1/subscriptions/:sub_id",
               delete(delete_individual_subcription::<I, A>).get(get_individual_subcription::<I, A>).put(replace_individual_subcription::<I, A>),
        )
        .route("/nsmf-nidd/v1/pdu-sessions/:pdu_session_ref/deliver",
               post(deliver::<I, A>),
        )
        .route("/nsmf-pdusession/v1/pdu-sessions",
               post(post_pdu_sessions::<I, A>),
        )
        .route("/nsmf-pdusession/v1/pdu-sessions/:pdu_session_ref/modify",
               post(update_pdu_session::<I, A>),
        )
        .route("/nsmf-pdusession/v1/nsmf-pdusession/v1/pdu-sessions/:pdu_session_ref/release",
               post(release_pdu_session::<I, A>),
        )
        .route("/nsmf-pdusession/v1/pdu-sessions/:pdu_session_ref/retrieve",
               post(retrieve_pdu_session::<I, A>),
        )
        .route("/nsmf-pdusession/v1/pdu-sessions/:pdu_session_ref/transfer-mo-data",
               post(transfer_mo_data::<I, A>),
        )
        .route("/nsmf-pdusession/v1/sm-contexts",
               post(post_sm_contexts::<I, A>),
        )
        .route("/nsmf-pdusession/v1/sm-contexts/:sm_context_ref/modify",
               post(update_sm_context::<I, A>),
        )
        .route("/nsmf-pdusession/v1/sm-contexts/:sm_context_ref/release",
               post(release_sm_context::<I, A>),
        )
        .route("/nsmf-pdusession/v1/sm-contexts/:sm_context_ref/retrieve",
               post(retrieve_sm_context::<I, A>),
        )
        .route("/nsmf-pdusession/v1/sm-contexts/:sm_context_ref/send-mo-data",
...
/// ReleasePduSession - POST /nsmf-pdusession/v1/nsmf-pdusession/v1/pdu-sessions/{pduSessionRef}/release
#[tracing::instrument(skip_all)]
    ...
    A: apis::individual_pdu_session_hsmfor_smf::IndividualPduSessionHsmforSmf,
{
    ...
    let result = api_impl.as_ref().release_pdu_session(
        method,
        host,
        cookies,
        path_params,
...
fn retrieve_pdu_session_validation(
    ...
    models::RetrievePduSessionPathParams,
    models::RetrieveData,
), ValidationErrors>
{
    path_params.validate()?;
...
/// RetrievePduSession - POST /nsmf-pdusession/v1/nsmf-pdusession/v1/pdu-sessions/{pduSessionRef}/retrieve
#[tracing::instrument(skip_all)]
    ...
    A: apis::individual_pdu_session_hsmfor_smf::IndividualPduSessionHsmforSmf,
{
    ...
    let validation = tokio::task::spawn_blocking(move ||
        retrieve_pdu_session_validation(
            path_params,
            body,
        )
    ).await.unwrap();
    ...
    let result = api_impl.as_ref().retrieve_pdu_session(
        method,
        host,
        cookies,
        path_params,
...
fn transfer_mo_data_validation(
    ...
    models::TransferMoDataPathParams,
), ValidationErrors>
{
    path_params.validate()?;
...
/// TransferMoData - POST /nsmf-pdusession/v1/nsmf-pdusession/v1/pdu-sessions/{pduSessionRef}/transfer-mo-data
#[tracing::instrument(skip_all)]
    ...
    A: apis::individual_pdu_session_hsmfor_smf::IndividualPduSessionHsmforSmf,
{
    ...
    let result = api_impl.as_ref().transfer_mo_data(
        method,
        host,
        cookies,
        path_params,
...
fn update_pdu_session_validation(
    ...
    models::UpdatePduSessionPathParams,
    models::HsmfUpdateData,
), ValidationErrors>
{
    path_params.validate()?;
...
/// UpdatePduSession - POST /nsmf-pdusession/v1/nsmf-pdusession/v1/pdu-sessions/{pduSessionRef}/modify
#[tracing::instrument(skip_all)]
    ...
    A: apis::individual_pdu_session_hsmfor_smf::IndividualPduSessionHsmforSmf,
{
    ...
    let result = api_impl.as_ref().update_pdu_session(
        method,
        host,
        cookies,
        path_params,
    ...
    A: apis::individual_pdu_session_nsmf_nidd::IndividualPduSessionNsmfNidd,
{
    ...
    let result = api_impl.as_ref().deliver(
        method,
        host,
        cookies,
        path_params,
    ...
    A: apis::individual_sm_context::IndividualSmContext,
{
    ...
    let result = api_impl.as_ref().release_sm_context(
        method,
        host,
        cookies,
        path_params,
    ...
    A: apis::individual_sm_context::IndividualSmContext,
{
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move ||
        retrieve_sm_context_validation(
            path_params,
            body,
        )
    ).await.unwrap();
    ...
    let result = api_impl.as_ref().retrieve_sm_context(
        method,
        host,
        cookies,
        path_params,
    ...
    A: apis::individual_sm_context::IndividualSmContext,
{
    ...
    let result = api_impl.as_ref().send_mo_data(
        method,
        host,
        cookies,
        path_params,
    ...
    A: apis::individual_sm_context::IndividualSmContext,
{
    ...
    let result = api_impl.as_ref().update_sm_context(
        method,
        host,
        cookies,
        path_params,
...
fn delete_individual_subcription_validation(
    ...
    models::DeleteIndividualSubcriptionPathParams,
), ValidationErrors>
{
    path_params.validate()?;
    ...
    A: apis::individual_subscription_document::IndividualSubscriptionDocument,
{
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move ||
        delete_individual_subcription_validation(
            path_params,
        )
    ).await.unwrap();
    ...
    let result = api_impl.as_ref().delete_individual_subcription(
        method,
        host,
        cookies,
        path_params,
...
fn get_individual_subcription_validation(
    ...
    models::GetIndividualSubcriptionPathParams,
), ValidationErrors>
{
    path_params.validate()?;
    ...
    A: apis::individual_subscription_document::IndividualSubscriptionDocument,
{
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move ||
        get_individual_subcription_validation(
            path_params,
        )
    ).await.unwrap();
    ...
    let result = api_impl.as_ref().get_individual_subcription(
        method,
        host,
        cookies,
        path_params,
    ...
    A: apis::individual_subscription_document::IndividualSubscriptionDocument,
{
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move ||
        replace_individual_subcription_validation(
            path_params,
            body,
        )
    ).await.unwrap();
    ...
    let result = api_impl.as_ref().replace_individual_subcription(
        method,
        host,
        cookies,
        path_params,
    ...
    A: apis::pdu_sessions_collection::PduSessionsCollection,
{
    ...
    let result = api_impl.as_ref().post_pdu_sessions(
        method,
        host,
        cookies,
        body,
    ...
    A: apis::sm_contexts_collection::SmContextsCollection,
{
    ...
    let result = api_impl.as_ref().post_sm_contexts(
        method,
        host,
        cookies,
        body,
    ...
    A: apis::subscriptions_collection::SubscriptionsCollection,
{
    #[allow(clippy::redundant_closure)]
    let validation = tokio::task::spawn_blocking(move ||
        create_individual_subcription_validation(
            body,
        )
    ).await.unwrap();
    ...
    let result = api_impl.as_ref().create_individual_subcription(
        method,
        host,
        cookies,
        body,
